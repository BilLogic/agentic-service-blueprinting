...
erDiagram
  ...
  touchpoints { uuid id PK  text name "the identity — unique across the deployment; no service owns one"  text kind "app | document | physical | channel | service | other"  text summary "what this touchpoint IS, for the deployment"  text url  text origin }
