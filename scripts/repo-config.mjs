...
export const repoConfig = {
  ...
  docsIndex: {
    ...
    routing: [
      ...
      ['Why did the large editor components wait to be split, and what did splitting one do?', 'docs/adr/0017-large-component-splits-wait-for-an-end-to-end-round.md'],
