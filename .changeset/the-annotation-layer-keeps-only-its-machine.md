...
`CanvasAnnotationResizeHandles.tsx`, the bars in `ShapeStyleBar.tsx`,
`StickyStyleBar.tsx` and `TextStyleBar.tsx` over a shared
`CanvasAnnotationBarChrome.tsx`, and the nodes in `ShapeAnnotationNode.tsx`,
