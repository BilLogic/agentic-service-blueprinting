...
including none. An upload joins that set as an `image_url` member. Un-citing
a cell drops that cell's member from the set; citing it again does not put
it back. A slide and the board may differ only
