...
erDiagram
  ...
  touchpoints { uuid id PK  text name "the identity — unique across the deployment; no service owns one"  text kind "app | document | physical | channel | service | other"  text summary "what this touchpoint IS, for the deployment"  text url  uuid stakeholder_id FK "the actor who owns it, or null — nobody has said yet; on delete set null"  text origin }
