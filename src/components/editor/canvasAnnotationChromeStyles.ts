...
export const SHAPE_TOOLBAR_TRIGGER_CLASS =
 ...
 * no label gutter.
 */
export const SHAPE_TOOLBAR_ICON_BUTTON_CLASS =
...
export const SHAPE_TOOLBAR_MENU_CLASS =
...
export const SHAPE_TOOLBAR_ITEM_CLASS =
