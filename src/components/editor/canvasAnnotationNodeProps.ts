 ...
 * layer to change one of those. The layer mints one of these per mark; the
 * mark reads it and never reaches past it, which is why `AnnotationMarkNode`
 * can sit in a module of its own without knowing the machine exists.
 *
