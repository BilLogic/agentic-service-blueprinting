    ...
    >
      <div
        className={cn(
          ...
          isPanel &&
            'w-full flex-1 gap-2 rounded-2xl border border-dashed border-border bg-[color:var(--background-blueprint-panel-section,var(--secondary))] px-5 py-6',
          isPhase &&
            'w-full flex-1 gap-2 rounded-2xl border border-dashed border-border bg-[color:var(--background-blueprint-panel-canvas,var(--secondary))] px-6 py-7',
        )}
      >
